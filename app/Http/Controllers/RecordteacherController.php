...
class RecordteacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($coursees as $coursee) {
                ...
                if ($learnCount < $coursee->learn_amount) {
                    ...
                    if($sumlearn == $coursee->learn_amount){
                        ...
                        return redirect()->route('recordteacher')->with('success', "ยินดีด้วยครั้งนี้เรียนครบเเล้ว $sumlearn/$coursee->learn_amount ");
                        ...
                        return redirect()->route('recordteacher')->with('success', "บันทึกการเรียนสำเร็จ $sumlearn/$coursee->learn_amount ");
                    }
            ...
            return redirect()->route('recordteacher')->with('error', 'ไม่พบคอร์สเรียนที่สามารถบันทึกข้อมูลได้');

        } catch (\Exception $e) {
            return redirect()->route('recordteacher')->with('error', 'เกิดข้อผิดพลาดในการบันทึกการเรียน');
        }
    }
